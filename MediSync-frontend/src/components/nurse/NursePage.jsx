...
import DepartmentDisplayBoard from './DepartmentDisplayBoard';
import DepartmentTokens from './DepartmentTokens';
        ...
        <div className="max-w-md w-full bg-white shadow-md rounded-lg p-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">
              You need to be logged in as a nurse to access this page.
            </p>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between space-y-4 lg:space-y-0">
              ...
              <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6 text-sm text-gray-600">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-medium">Nurse Portal v1.0</span>
                </div>
                <div className="hidden sm:block text-gray-400">|</div>
                <div className="flex items-center space-x-2">
                  <span className="text-pink-600">👩‍⚕️</span>
                  <span>Nurse: {user.name}</span>
                </div>
                <div className="hidden sm:block text-gray-400">|</div>
                <div className="flex items-center space-x-2">
